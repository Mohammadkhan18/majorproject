...
loader_model = pickle.load(open(r'D:\majorproject\Autism-Spectrum-Disorder\trained_model.sav', 'rb'))
...
def asd_info_page():
    st.title("Learn About Autism Spectrum Disorder (ASD)")
    st.markdown("""
    ...
    **Diagnosis:**
    - Diagnosing ASD can be difficult because there is no medical test, like a blood test, to diagnose the disorders. Doctors look at the child’s behavior and development to make a diagnosis.
    ...
    **Treatment:**
    ...
    For more information, you can visit [CDC - Autism Spectrum Disorder (ASD)](https://www.cdc.gov/ncbddd/autism/index.html)
    """)
...
def main():
    ...
    original_image = Image.open(r'D:\majorproject\Autism-Spectrum-Disorder\asd2_cleanup.png')
    ...
    f = st.selectbox("Family Member With ASD", ["", "YES", "NO"])
    if f == "YES":
        fm = 1
    else:
        fm = 0
    ...
    if st.button("Learn More About ASD"):
        asd_info_page()
